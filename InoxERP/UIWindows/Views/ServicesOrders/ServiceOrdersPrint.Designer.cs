namespace UIWindows.Views.ServicesOrders
{
    partial class ServiceOrdersPrint
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DataSetItemsPrint";
            reportDataSource1.Value = this.tbitemsBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "UIWindows.Business.Reports.ServiceOrders.ServiceOrdersPrint.rdlc";
