...
{
    public partial class SituationBudgetsReport : Form
    {
        string typeReport, startDateReport, endDateReport, situationReport;

        public SituationBudgetsReport(string type, string startDate, string endDate, string situation)
        {
            typeReport = type;
        ...
        public void searchData()
        {
            ...
            reportViewer1.LocalReport.DisplayName = "Relatorio de Orcamentos " + typeReport + " - " + DateTime.Now.Date.ToShortDateString().Replace("/", "-");
