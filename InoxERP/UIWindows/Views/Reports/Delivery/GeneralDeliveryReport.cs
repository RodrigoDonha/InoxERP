...
{
    public partial class GeneralDeliveryReport : Form
    {
        string typeReport, startDateReport, endDateReport, situationReport;

        public GeneralDeliveryReport(string type, string startDate, string endDate, string situation)
        {
            typeReport = type;
        ...
        private void GeneralDeliveryReport_Load(object sender, EventArgs e)
        {
