...
{
    public partial class AccountsPaymentsReport : Form
    {
        string typeReport, startDateReport, endDateReport, typeLaunchReport;

        public AccountsPaymentsReport(string type, string startDate, string endDate, string typeLaunch)
        {
            typeReport = type;
        ...
        private void AccountsPayReport_Load(object sender, EventArgs e)
        {
        ...
        public void searchData()
        {
            ...
            reportViewer1.LocalReport.DisplayName = "Relatorio de " + typeReport + " - " +
