...
{
    public partial class AccountsPayableReport : Form
    {
        string typeReport, startDateReport, endDateReport, typeLaunchReport;

        public AccountsPayableReport(string type, string startDate, string endDate, string typeLaunch)
        {
            typeReport = type;
        ...
        public void searchData()
        {
            ...
            reportViewer1.LocalReport.DisplayName = "Relatorio de " + typeReport + " - " + DateTime.Now.Date.ToShortDateString().Replace("/","-");
