...
{
    public partial class AccountsReceivedReport : Form
    {
        string typeReport, startDateReport, endDateReport, typeLaunchReport;

        public AccountsReceivedReport(string type, string startDate, string endDate, string typeLaunch)
        {
            typeReport = type;
        ...
        private void AccountsReceivedReport_Load(object sender, EventArgs e)
        {
