...
{
    public partial class AccountsReceivableReport : Form
    {
        string typeReport, startDateReport, endDateReport, typeLaunchReport;

        public AccountsReceivableReport(string type, string startDate, string endDate, string typeLaunch)
        {
            typeReport = type;
        ...
        private void AccountsReceivableReport_Load(object sender, EventArgs e)
        {
