...
{
    public partial class SituationServiceOrdersReport : Form
    {
        string typeReport, startDateReport, endDateReport, situationReport;

        public SituationServiceOrdersReport(string type, string startDate, string endDate, string situation)
        {
            typeReport = type;
        ...
        private void SituationServiceOrdersReport_Load(object sender, EventArgs e)
        {
