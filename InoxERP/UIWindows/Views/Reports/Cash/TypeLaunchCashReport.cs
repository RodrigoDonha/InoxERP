...
{
    public partial class TypeLaunchCashReport : Form
    {
        string typeReport, startDateReport, endDateReport;
        private int typeLaunchReport;

        public TypeLaunchCashReport(string type, string startDate, string endDate, int typeLaunch)
        {
            typeReport = type;
