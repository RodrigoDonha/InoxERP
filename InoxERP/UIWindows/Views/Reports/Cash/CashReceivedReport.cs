...
{
    public partial class CashReceivedReport : Form
    {
        string typeReport, startDateReport, endDateReport;
        int typeLaunchReport;

        public CashReceivedReport(string type, string startDate, string endDate, int typeLaunch)
        {
            typeReport = type;
        ...
        private void CashReceivedReport_Load(object sender, EventArgs e)
        {
