    ...
    public partial class frmAccountsToReceive : Form
    {
        ...
        private void grdAReceber_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                lblValorAReceber.Text = grdAReceber[13, grdAReceber.CurrentRow.Index].Value.ToString();
        ...
        private AccountsToReceive calcParcialPayment(AccountsToReceive acc, decimal txtValue)
        {
